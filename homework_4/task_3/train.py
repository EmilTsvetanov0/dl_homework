...
from homework_4.task_3.dataset import LoanCollator, load_loan_data, _NUMERIC_DTYPES
from homework_4.task_3.lion import Lion
...
def train(
    ...
    run = Run(experiment=f"weight_decay_and_lr_search")
    run["hparams"] = {
        "dropout_p": dropout_p,
        "learning_rate": lr,
...
if __name__ == '__main__':
    ...
    print(f"\n=== Training with weight_decay={weight_decay} and learning rate={lr} ===")
    train(train_ds, test_ds, weight_decay=weight_decay, lr=lr)