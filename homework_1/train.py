...
from dataset import LoanCollator, load_loan_data, _NUMERIC_DTYPES
...
def train(train_dataset: Dataset, eval_dataset: Dataset):
    ...
    model = LoanModel(hidden_size=base_hidden_size).to(dev)
...
if __name__ == '__main__':
    train_ds, test_ds = load_loan_data(Path('/home/me/projects/misis-2526/data/titanic.csv'))
